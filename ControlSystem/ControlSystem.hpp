...
/*位置控制*/
	...
	/*水平位置*/
		...
		//设定航点半径
		bool Position_Control_set_WpRange( double range, double TIMEOUT=-1 );
	...
	/*OffBoard模式*/
		/*XY*/
			...
			int Position_Control_set_TargetPosVelAccXY_OffBoard_int( double posx, double posy, double velx, double vely, double accx, double accy, double TIMEOUT=-1 );
			//控制位置（经纬度）+速度+推力
