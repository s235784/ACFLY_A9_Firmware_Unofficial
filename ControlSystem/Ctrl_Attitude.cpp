...
/*内部接口*/
	...
	float get_RolTD4P1() { return cfg.TD4_P1[0]; }
	float get_RolTD4P2() { return cfg.TD4_P2[0]; }
	float get_RolTD4P3() { return cfg.TD4_P3[0]; }
	float get_RolTD4P4() { return cfg.TD4_P4[0]; }
	float get_PitTD4P1() { return cfg.TD4_P1[2]; }
	float get_PitTD4P2() { return cfg.TD4_P2[2]; }
	float get_PitTD4P3() { return cfg.TD4_P3[2]; }
	float get_PitTD4P4() { return cfg.TD4_P4[2]; }
	float get_YawTD4P1() { return cfg.TD4_P1[4]; }
	float get_YawTD4P2() { return cfg.TD4_P2[4]; }
	float get_YawTD4P3() { return cfg.TD4_P3[4]; }
	float get_YawTD4P4() { return cfg.TD4_P4[4]; }
/*内部接口*/
...
/*机型控制方式*/
	...
	/*多旋翼*/
		...
		{
			//初始化姿态ESO
			ESO[0].init( cfg.order[0], cfg.T[0], cfg.b[0], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[1].init( cfg.order[0], cfg.T[0], cfg.b[2], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[2].init( cfg.order[0], 1.0/(CtrlRateHz*CtrlRateDiv), cfg.b[4], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
		}
	...
	/*三轴*/
		static void TriRotor_Init()
		{
			...
			ESO[0].init( cfg.order[0], cfg.T[0], cfg.b[0], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[1].init( cfg.order[0], cfg.T[0], cfg.b[2], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[2].init( cfg.order[0], cfg.T2[0], cfg.b[4], cfg.beta2[0], cfg.beta2[0], CtrlRateHz*CtrlRateDiv );
		}
...
//			ESOHeli[1].init( cfg.T[0], cfg.b[2]*Heli_RPb_scale, cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[0].init( cfg.order[0], cfg.T[0], cfg.b[0], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[1].init( cfg.order[0], cfg.T[0], cfg.b[2], cfg.beta[0], cfg.beta[0], CtrlRateHz*CtrlRateDiv );
			ESO[2].init( cfg.order[0], 1.0/(CtrlRateHz*CtrlRateDiv), cfg.b[4], cfg.beta2[0], cfg.beta2[0], CtrlRateHz*CtrlRateDiv );
		}
